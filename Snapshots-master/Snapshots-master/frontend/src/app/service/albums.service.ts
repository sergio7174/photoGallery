...
export class AlbumsService {
  ...
  createAlbum(album, selectedFile): Observable<any> {
   ...
   // alert("Estoy en albums.service.ts - line 23 - uploadData.coverImage:"+ uploadData['coverImage'])
    // alert("Estoy en albums.service.ts - line 24 - selectedFile:"+ selectedFile)
